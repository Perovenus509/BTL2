...
export default function Manage({remove,update,managelist}) {
    ...
    return (
       <div className="manager">
            <Container className="header-manager">
                <Row>
                    <Col md ={11} style={{backgroundColor:"#bdc3c7",cursor:"pointer"}}>
                        DANH SÁCH TRƯỞNG NHÀ
                    </Col>
                    <Col style={{backgroundColor:"#bdc3c7",cursor:"pointer"}}>
                        <Link to="/Han/building">  {'>>'} </Link>
                    </Col>
                </Row>
           </Container>
